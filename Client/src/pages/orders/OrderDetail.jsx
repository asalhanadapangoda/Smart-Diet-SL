      ...
      <ProtectedRoute>
        <div className="container mx-auto px-4 py-8 relative">
          <div className="text-center py-12">
            ...
            <p className="text-gray-700 mt-4 text-glass">Loading order details...</p>
          </div>
        </div>
      </ProtectedRoute>
    );
  ...
  if (!order) {
    return (
      <ProtectedRoute>
        <div className="container mx-auto px-4 py-8 relative">
          <div className="text-center py-12">
            <p className="text-gray-700 mb-4 text-glass text-xl">Order not found</p>
            <Link
              to="/orders"
    ...
    <ProtectedRoute>
      <div className="container mx-auto px-4 py-8 relative max-w-4xl">
        <div className="mb-6">
          <Link
            to="/orders"
            className="text-gray-700 hover:text-green-600 transition-colors text-glass inline-flex items-center mb-4"
          >
        ...
        <div className="glass-card rounded-2xl p-6 mb-6 backdrop-blur-xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              <h2 className="text-2xl font-semibold text-gray-800 text-glass mb-2">
            ...
            <div className="flex flex-col items-start md:items-end gap-2">
              ...
              <span className="text-2xl font-bold text-gray-800 text-glass">
          ...
          <div className="border-t border-gray-200 pt-6">
            <h3 className="text-xl font-semibold text-gray-800 text-glass mb-4">Order Items</h3>
            <div className="space-y-4">
              {order.orderItems?.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gap-4 p-4 glass-card bg-gray-50 rounded-xl"
                >
                  <img
                    src={item.image}
                    alt={item.name}
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-800 text-glass mb-1">{item.name}</h4>
                    <p className="text-gray-600 text-sm text-glass">
                      Quantity: {item.quantity} × Rs. {item.price}
                    </p>
                  </div>
                  <p className="font-bold text-gray-800 text-glass">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="glass-card rounded-2xl p-6 backdrop-blur-xl">
            <h3 className="text-xl font-semibold text-gray-800 text-glass mb-4">Shipping Address</h3>
            {order.shippingAddress ? (
              <div className="space-y-2 text-gray-700 text-glass">
              ...
              <p className="text-gray-600 text-glass">No shipping address provided</p>
            )}
          </div>

          <div className="glass-card rounded-2xl p-6 backdrop-blur-xl">
            <h3 className="text-xl font-semibold text-gray-800 text-glass mb-4">Order Summary</h3>
            <div className="space-y-3">
              ...
              <div className="pt-3 border-t border-gray-200">
                <div className="flex justify-between text-gray-700 text-glass mb-2">
